...
// adds a link that send to the specific anecdote address
...
const App = () => {
    ...
    //getting the specific anecdote requested if at an id address
    ...
    //menu and footer should always be there
    // Router is in the index.js rendering part
    return (
        <div>
